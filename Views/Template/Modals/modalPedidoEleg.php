<!-- Modal -->
<div class="modal fade" id="modalFormPedidoNeolux" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      <div class="modal-header headerRegister">
        <h5 class="modal-title" id="titleModal">Rollers Shades Motorizadas</h5>
      ...
      <div class="modal-body">
          <div class="tile">
            <div class="tile-body">
            <form id="formPedidoNeolux" name="formPedidoNeolux">
                <!-- --------------------------------------------------DATOS GENERALES -->
                ...
                <h3 class="box-title">Datos generales</h3>
                    ...
                    <div class="row">  
                      ...
                      <label for="exampleSelect1">CN:</label>
                       <input type="text" class="form-control" placeholder="CN" id="cnneolux" name="cnneolux">
                      </div> 
                     <div class="col">
                      <label for="exampleSelect1">Sucursal:</label>
                      <select class="form-control select2" id="suc_neolux" name="suc_neolux">
                      ...
                      <label for="exampleSelect1">Presupuestado por:</label>
                       <input type="text" class="form-control" id="vend_neolux" name="vend_neolux" placeholder="Nombre y Apellido">
                      </div>
                      <div class="col">
                      <label for="exampleSelect1">Medido por:</label>
                        <input type="text" class="form-control" id="medid_neolux" name="medid_neolux" placeholder="Nombre y Apellido">
                      </div>
                      <div class="col">
                      <label for="exampleSelect1">Metodo de entrega:</label>
                        <select class="form-control select2" id="entre_neolux" name="entre_neolux">
                          <option selected="selected">---</option>
                      ...
                      <label for="exampleSelect1">Fecha:</label>
                        <input type="date" class="form-control" id="date_neolux" name="date_neolux">
                      </div>                      
                    </div> 
