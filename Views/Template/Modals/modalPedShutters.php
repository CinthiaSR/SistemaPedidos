<!-- Modal -->
<div class="modal fade" id="modalFormPedidoShutters" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      ...
      <div class="modal-body">
          <div class="tile">
            <div class="tile-body">
            <form id="formPedidoShutters" name="formPedidoShutters">
                <!-- --------------------------------------------------DATOS GENERALES -->
                ...
                <h3 class="box-title">Datos generales</h3>
                    ...
                    <div class="row">
                        <div class="col">
                        <label for="exampleSelect1">Precio x ft2:</label>
                          <input type="text" class="form-control" id="ft2" name="ft2" placeholder="$">
                        </div>
