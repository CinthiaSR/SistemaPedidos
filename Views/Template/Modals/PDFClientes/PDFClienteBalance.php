...
<table class="tbl-hader">
		<tbody>
			<tr>
				...
				<td class="wd30"  style="font-size: 14px;"><b style="font-size: 14px;">Fecha: </b> <?= $orden['fecha'] ?> <br>
				...
				<td class="text-center wd30">
					<b style="font-size: 25px; ">Balance de madera</b> <br>
				</td>
			</tr>
		</tbody>
	</table>
	...
	<table class="tbl-detalle" style="border: 10px;">
		<thead>
			<tr>
				...
				<th style="background-color:#fff; color:black; border: 0.5px;">Tam. <br>  Retorno</th>
				<th style="background-color:#fff; color:black; border: 0.5px;">Cortes <br> Esp</th>
				<th style="background-color:#fff; color:black; border: 0.5px;">L para <br> instalación</th>
				<th style="background-color:#fff; color:black; border: 0.5px;">Tapa <br> Superior</th>
				<th style="background-color:#fff; color:black; border: 0.5px;">Forrado</th>
				<th style="background-color:#fff; color:black; border: 0.5px;">Nombre del <br> Forro</th>
		...
		<tbody>
			<?php 
				...
				foreach ($balance as $persiana) {
					...
					$subtotal += $persiana['bal_cantidad'];
			 ?>
			<tr>
				<td class="text-center"><?= $persiana['bal_cantidad'] ?></td>
				<td class="text-center"><?= $persiana['bal_identificacion'] ?></td>
				<td class="text-center"><?= $persiana['bal_media'] ?></td>
				<td class="text-center"><?= $persiana['bal_alto'].' x '.$persiana['bal_largo'] ?></td>
				<td class="text-center"><?= $persiana['bal_color'] ?></td>
				<td class="text-center"><?= $persiana['bal_retorno'] ?></td>
				<td class="text-center"><?= $persiana['bal_cortes'] ?></td>
				<td class="text-center"><?= $persiana['bal_L_instalacion'] ?></td>
				<td class="text-center"><?= $persiana['bal_tapasuperior'] ?></td>
				<td class="text-center"><?= $persiana['bal_forrado'] ?></td>
				<td class="text-center"><?= $persiana['bal_nombreforro'] ?></td>
                <td class="text-center">$ <?= $persiana['bal_preciototal'] ?></td>
			</tr>
			<?php } ?>
		</tbody>
        <tfoot>
			...
			<tr>
				<td colspan="11" class="text-right">Descuento: <b><?= $precio['porcentaje'] ?> %</b> </td>
			...
			<tr>
				<td colspan="11" class="text-right">Impuesto: <b><?= $precio['percenimp'] ?> %</b> </td>
