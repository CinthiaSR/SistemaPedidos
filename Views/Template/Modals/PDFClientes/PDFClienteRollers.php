		...
		<tbody>
			<tr>
				...
				<td class="text-center wd33">
					<b style="font-size: 25px; ">Roller Shades</b> <br>
					 Persiana Enrrollable<br>  
				</td>
			</tr>
		</tbody>
	</table>
	...
	<table class="tbl-detalle" style="border: 10px;">
		...
		<tbody>
			...
			<tr>
				...
				<td class="text-center"><?= $persiana['en_color_tela'] ?></td>
				<td class="text-center"><?= $persiana['en_typecontrol'] ?></td>
				<td class="text-center"><?= $persiana['en_colorcomponents'] ?></td>
				<td class="text-center"><?= $persiana['en_typesa'] ?></td>
				<td class="text-center"><?= $persiana['en_typecadena'] ?></td>
				<td class="text-center"><?= $persiana['en_m_cadena'] ?></td>
				<td class="text-center"><?= $persiana['en_control_motor'] ?></td>
				<td class="text-center"><?= $persiana['en_balance'] ?></td>
				<td class="text-center">$ <?= $persiana['en_preciounit'] ?></td>
				<td class="text-center">$ <?= $persiana['en_precio'] ?></td>
		...
		<tfoot>
			...
			<!-- <tr>
				<td colspan="13" class="text-right">Motorización:</td>
