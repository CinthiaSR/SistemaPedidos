		...
		<tbody>
			<tr>
				...
				<td class="text-center wd33">
					<b style="font-size: 25px;">Neolux Motorizadas</b> <br>
				</td>
			</tr>
		</tbody>
	</table>
	...
	<table class="tbl-detalle" style="border: 10px;">
		<thead>
			<tr>
                ...
                <th style="background-color:#fff; color:black; border: 0.5px;">Marca</th>
		...
		<tbody>
			<?php 
				...
				foreach ($roller as $persiana) {
                    $subtotal +=$persiana['ne_cantidad'];
			 ?>
			<tr>
				<td class="text-center"><?= $persiana['ne_cantidad'] ?></td>
				<td class="text-center"><?= $persiana['ne_identificacion'] ?></td>
				<td class="text-center"><?= $persiana['ne_instalacion'] ?></td>
				<td class="text-center"><?= $persiana['ne_ancho'].' x '.$persiana['ne_largo'] ?></td>
				<td class="text-center"><?= $persiana['ne_color_tela'] ?></td>
				<td class="text-center"><?= $persiana['ne_colorcomp'] ?></td>
				<td class="text-center"><?= $persiana['ne_typesa'] ?></td>
				<td class="text-center"><?= $persiana['ne_ctrlmotor'] ?></td>
				<td class="text-center"><?= $persiana['ne_cassette'] ?></td>                
				<td class="text-center"><?= $persiana['ne_marca'] ?></td>
				<td class="text-center"><?= $persiana['ne_tipo'] ?></td>
				<td class="text-center">$ <?= $persiana['ne_preciounit'] ?></td>
				<td class="text-center">$ <?= $persiana['ne_precio'] ?></td>
		...
		<tfoot>
			...
			<tr>
				...
				<td class="text-right"><?= SMONEY . $precio['anticipo'] ?></td>
			</tr>
			<tr>
