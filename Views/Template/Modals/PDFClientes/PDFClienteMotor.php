		...
		<tbody>
			<tr>
				...
				<td class="text-center wd33">
					<b style="font-size: 25px; ">Roller Shades  <br> Motorizadas</b> <br>
					 Persianas Motorizadas<br>  
				</td>
			</tr>
		</tbody>
	</table>
	...
	<table class="tbl-detalle" style="border: 10px;">
		<thead>
			<tr>
				...
				<th style="background-color:#fff; color:black; border: 0.5px;">Control y <br> enrrolle</th>
				<th style="background-color:#fff; color:black; border: 0.5px;">Balance</th>
                <th style="background-color:#fff; color:black; border: 0.5px;">Tipo de <br> complemento</th>
                <th style="background-color:#fff; color:black; border: 0.5px;">Nombre</th>
		...
		<tbody>
			<?php 
				...
				foreach ($roller as $persiana) {
					...
					$subtotal +=$persiana['mo_cantidad']
			 ?>
			<tr>
				<td class="text-center"><?= $persiana['mo_cantidad'] ?></td>
				<td class="text-center"><?= $persiana['mo_identificacion'] ?></td>
				<td class="text-center"><?= $persiana['mo_instalacion'] ?></td>
				<td class="text-center"><?= $persiana['mo_ancho'].' x '.$persiana['mo_largo'] ?></td>
				<td class="text-center"><?= $persiana['mo_color_tela'] ?></td>
				<td class="text-center"><?= $persiana['mo_colorcomp'] ?></td>
				<td class="text-center"><?= $persiana['mo_pesa'] ?></td>
				<td class="text-center"><?= $persiana['mo_ctrl_motor'] ?></td>
				<td class="text-center"><?= $persiana['mo_balance'] ?></td>
				<td class="text-center"><?= $persiana['mo_marca'] ?></td>
				<td class="text-center"><?= $persiana['mo_tipo'] ?></td>
                <td class="text-center">$ <?= $persiana['mo_preciounit'] ?></td>
				<td class="text-center">$ <?= $persiana['mo_precio'] ?></td>
