		...
		<tbody>
			<tr>
				...
				<td class="text-center wd33">
					<b style="font-size: 25px;">Neolux <br> Manuales</b> <br>
				</td>
			</tr>
		</tbody>
	</table>
	...
	<table class="tbl-detalle" style="border: 10px;">
		<thead>
			<tr>
				...
				<th style="background-color:#fff; color:black; border: 0.5px;">Color <br> componentes</th>
				<th style="background-color:#fff; color:black; border: 0.5px;">Tipo de pesa</th>
				<th style="background-color:#fff; color:black; border: 0.5px;">Tipo de  cadena</th>
				<th style="background-color:#fff; color:black; border: 0.5px;">Cadena (in)</th>
				<th style="background-color:#fff; color:black; border: 0.5px;">Control y enrrolle</th>
				<th style="background-color:#fff; color:black; border: 0.5px;">Balance</th>
				<th style="background-color:#fff; color:black; border: 0.5px;">Precio <br> Unitario</th>
		...
		<tbody>
			<?php 
				...
				foreach ($roller as $persiana) {
					...
					$subtotal += $persiana['sheer_cantidad'];
			 ?>
			<tr>
				<td class="text-center"><?= $persiana['sheer_cantidad'] ?></td>
				<td class="text-center"><?= $persiana['sheer_identificacion'] ?></td>
				<td class="text-center"><?= $persiana['sheer_instalacion'] ?></td>
				<td class="text-center"><?= $persiana['sheer_ancho'].' x '.$persiana['sheer_largo'] ?></td>
				<td class="text-center"><?= $persiana['sheer_color_tela'] ?></td>
				<td class="text-center"><?= $persiana['sheer_typecontrol'] ?></td>
				<td class="text-center"><?= $persiana['sheer_colorcomponents'] ?></td>
				<td class="text-center"><?= $persiana['sheer_typesa'] ?></td>
				<td class="text-center"><?= $persiana['sheer_typecadena'] ?></td>
				<td class="text-center"><?= $persiana['sheer_m_cadena'] ?></td>
				<td class="text-center"><?= $persiana['sheer_control_motor'] ?></td>
				<td class="text-center"><?= $persiana['sheer_cassette'] ?></td>
				<td class="text-center">$ <?= $persiana['sheer_preciounit'] ?></td>
				<td class="text-center">$ <?= $persiana['sheer_precio'] ?></td>
