	...
	<table class="tbl-detalle" style="border: 10px;">
		<thead>
			<tr>
				...
				<th style="background-color:#fff; color:black; border: 0.5px;">Plantilla</th>
		...
		<tbody>
			...
			<tr>
				...
				<td class="text-center"><?= $persiana['arcos_plant'] ?></td>
				<td class="text-center">$ <?= $persiana['arcos_preciounit'] ?></td>
				<td class="text-center">$ <?= $persiana['arcos_preciototal'] ?></td>
			</tr>
			<?php } ?>
		</tbody>
		<tfoot>
			...
			<tr>
				...
				<td colspan="8" class="text-right">Importe:</td>
				<td class="text-right"><?= SMONEY. $precio['importe'] ?></td>
			</tr>
			<!-- <tr>
				<td colspan="9" class="text-right">Descuento: <b><= $precio['porcentaje'] ?> %</b> </td>
			...
			<tr>
				<td colspan="10" class="text-right">Instalacion:</td>
				<td class="text-right"><?= SMONEY . $precio['instalacion'] ?></td>
			</tr>
			<tr>
				<td colspan="10" class="text-right">Impuesto: <b><?= $precio['percenimp'] ?> %</b> </td>
			...
			<tr>
				<td colspan="10" class="text-right">Anticipo:</td>
