  ...
  <div class="modal-dialog modal-xl">
    <div class="modal-content">
      ...
      <div class="modal-body">
          <div class="tile">
            <div class="tile-body">
            <form id="formPedidoBalance" name="formPedidoBalance">
                <!-- --------------------------------------------------DATOS GENERALES -->
                ...
                <h3 class="box-title">Datos generales</h3>
                    ...
                    <div class="row">  
                      ...
                      <label for="exampleSelect1">CN:</label>
                       <input type="text" class="form-control" placeholder="CN" id="cn" name="cn">
                      </div> 
                     <div class="col">
                      <label for="exampleSelect1">Sucursal:</label>
                      <select class="form-control select2" id="suc" name="suc">
                      ...
                      <label for="exampleSelect1">Presupuestado por:</label>
                       <input type="text" class="form-control" id="vend" name="vend" placeholder="Nombre y Apellido">
                      </div>
                      <div class="col">
                      <label for="exampleSelect1">Medido por:</label>
                        <input type="text" class="form-control" id="medid" name="medid" placeholder="Nombre y Apellido">
                      </div>
                      <div class="col">
                      <label for="exampleSelect1">Metodo de entrega:</label>
                        <select class="form-control select2" id="entre" name="entre">
                          <option selected="selected">---</option>
