...
<table class="tbl-hader">
		<tbody>
			<tr>
				...
				<td class="text-center wd23">
				<p><b style="font-size: 25px;">Neolux  <br>Motorizadas</b>
					<br>Notas Especiales</p>
				</td>
			</tr>
		</tbody>
	</table>
	...
	<table class="tbl-detalle" style="border: 10px;">
		<thead>
			<tr>
                ...
                <th style="background-color:#fff; color:black; border: 0.5px;">Notas</th>
            </tr>
            </thead>
		<tbody>
			<?php 
			...
			<tr>
				...
				<td class="text-center"><?= $persiana['ne_nota'] ?></td>
