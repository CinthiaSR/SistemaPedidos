            ...
            <table class="table table-hover table-bordered" id="tableBlindsRollers">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?= $persiana['en_ancho'] ?></td>
                    <td><?= $persiana['en_largo'] ?></td>
                    <td><?= $persiana['en_color_tela'] ?></td>
                    <td><?= $persiana['en_precio'] ?></td>
                    <td>
                          <!-- <button class="btn btn-info btn-sm"    onClick="fntViewRoller(<?=$persiana['ID_ENRROLLABLE']?>)" title="Ver Roller"><i class="far fa-eye"></i> </button> -->
                          <button class="btn btn-primary btn-sm" onClick="fntEditRoller(<?=$persiana['ID_ENRROLLABLE']?>)" title="Editar Roller"><i class="fas fa-pencil-alt"></i></button>
                          <button class="btn btn-danger btn-sm"   onClick="fntDelRoller(<?=$persiana['ID_ENRROLLABLE']?>)" title="Eliminar Roller"><i class="far fa-trash-alt"></i></button>                                 
                    </td>
                  </tr>
                  <?php 
                            }
          ...
          <form id="formPrice" name="formPrice" class="form-horizontal">
            ...
            <div class="row d-print-none mt-2">
             ...
             <?php
                    if(!empty($persiana['en_nota'])){ ?>
                    <?php }else{ ?>
                      <a class="btn btn-outline-info" href="<?=base_url().'/rollers/PDFNOTES/'.$orden['idpedido']?>" target="_blanck"><i class="fa fa-print"></i> Imprimir notas especiales</a> 
                    <?php } ?>
             ...
             <php }
              ?>         -->
              <a class="btn btn-success" href="<?=base_url().'/rollers/facturacliente/'.$orden['idpedido']?>" target="_blanck"><i class="fa fa-print"></i> PDF Cliente</a> 
               <a class="btn btn-warning" href="<?=base_url().'/rollers/facturaproduccion/'.$orden['idpedido']?>" target="_blanck" ><i class="fa fa-print"></i> PDF Produccion</a>
              </div> 
          </div>
          </form>
        </section>
