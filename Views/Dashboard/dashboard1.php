...
<php footerAdmin($data); ?>
    ...
    <main class="app-content">
      ...
      <div class="row">
        ...
        <div class="col-md-6 col-lg-3">
          <a href="<?= base_url() ?>/arcos" class="linkw">
        ...
        <?php if(!empty($_SESSION['permisos'][5]['r'])){ ?>
        <div class="col-md-6 col-lg-3">
          <a href="<?= base_url() ?>/balance" class="linkw">
            <div class="widget-small danger coloured-icon"><i class="icon fa fa-shopping-cart fa-3x"></i>
              <div class="info">
                <h4>Balances de madera</h4>
                <p><b><?= $data['balance'] ?></b></p>
              </div>
            </div>
          </a>
        </div>
      ...
      <div class="row">
        <?php if(!empty($_SESSION['permisos'][2]['r'])){ ?>
        <div class="col-md-6 col-lg-3">
          <a href="<?= base_url() ?>/horizontales" class="linkw">
           <div class="widget-small danger coloured-icon"><i class="icon fa fa-shopping-cart fa-3x"></i>
              <div class="info">
                <h4> Horizontales</h4>
                <p><b><?= $data['horizontal'] ?></b></p>
              </div>
            </div>
          </a>
        </div>
        ...
        <?php if(!empty($_SESSION['permisos'][3]['r'])){ ?>
        <div class="col-md-6 col-lg-3">
          <a href="<?= base_url() ?>/neolux" class="linkw">
            <div class="widget-small danger coloured-icon"><i class="icon fa fa-shopping-cart fa-3x"></i>
              <div class="info">
                <h4>Neolux Manuales</h4>
                <p><b><?= $data['neolux'] ?></b></p>
              </div>
            </div>
          </a>
        ...
        <?php if(!empty($_SESSION['permisos'][5]['r'])){ ?>
        <div class="col-md-6 col-lg-3">
          <a href="<?= base_url() ?>/elegance" class="linkw">
            <div class="widget-small danger coloured-icon"><i class="icon fa fa-shopping-cart fa-3x"></i>
              <div class="info">
                <h4>Neolux Motorizadas</h4>
                <p><b><?= $data['motor'] ?></b></p>
              </div>
            </div>
          </a>
        ...
        <?php if(!empty($_SESSION['permisos'][5]['r'])){ ?>
        <div class="col-md-6 col-lg-3">
          <a href="<?= base_url() ?>/rollers" class="linkw">
            <div class="widget-small danger coloured-icon"><i class="icon fa fa-shopping-cart fa-3x"></i>
              <div class="info">
                <h4>Roller Manuales</h4>
                <p><b><?= $data['roller'] ?></b></p>
              </div>
            </div>
          </a>
      ...
      <div class="row">
        <?php if(!empty($_SESSION['permisos'][2]['r'])){ ?>
        <div class="col-md-6 col-lg-3">
          <a href="<?= base_url() ?>/motorizacion" class="linkw">
            <div class="widget-small danger coloured-icon"><i class="icon fa fa-shopping-cart fa-3x"></i>
              <div class="info">
                <h4>Roller Motorizadas</h4>
                <p><b><?= $data['motorizacion'] ?></b></p>
              </div>
            </div>
          </a>
        </div>
        ...
        <?php if(!empty($_SESSION['permisos'][3]['r'])){ ?>
        <div class="col-md-6 col-lg-3">
          <a href="<?= base_url() ?>/romana" class="linkw">
           <div class="widget-small danger coloured-icon"><i class="icon fa fa-shopping-cart fa-3x"></i>
              <div class="info">
                <h4>Romanas</h4>
                <p><b><?= $data['romana'] ?></b></p>
        ...
        <?php if(!empty($_SESSION['permisos'][5]['r'])){ ?>
        <div class="col-md-6 col-lg-3">
          <a href="<?= base_url() ?>/shutters" class="linkw">
            <div class="widget-small danger coloured-icon"><i class="icon fa fa-shopping-cart fa-3x"></i>
              <div class="info">
                <h4>Shutters</h4>
                <p><b><?= $data['shutter'] ?></b></p>
              </div>
            </div>
          </a>
        </div>
