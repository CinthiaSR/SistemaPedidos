...
tablePedidos = $('#tablePedidos').dataTable( {
    ...
    "ajax":{
        "url": " "+base_url+"/Rollers/getPedidos",
        "dataSrc":""
    },
    "columns":[
        // {"data":"idpedido"},
    ...
    if(document.querySelector("#formPedidoRoller")){
        let formPedidoRoller = document.querySelector("#formPedidoRoller");
            ...
            request.onreadystatechange = function(){
                if(request.readyState == 4 && request.status == 200){
                    ...
                    if(objData.status){
                        ...
                        swal("Pedido Roller", objData.msg ,"success");
...
function openModal()
{
    ...
    document.querySelector("#formPedidoRoller").reset();
...
function fntEditPedido(idpedido){
    ...
    var ajaxUrl = base_url+'/Rollers/getPedido/'+idpedido;
    request.open("GET",ajaxUrl,true);
    request.send();
    request.onreadystatechange = function(){
...
function fntDelPedido(idpedido){
    ...
    swal({
        ...
        {
            var request = (window.XMLHttpRequest) ? new XMLHttpRequest() : new ActiveXObject('Microsoft.XMLHTTP');
            var ajaxUrl = base_url+'/Rollers/delPedido/';
